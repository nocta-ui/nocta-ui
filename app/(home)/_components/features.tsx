...
const featureItemVariants = cva(
	'group flex flex-col justify-between gap-10 p-6 transition-colors duration-300 ease-in-out last:border-b last:border-dashed last:border-border hover:bg-background-muted sm:gap-22 md:gap-34 lg:gap-46',
	{
		variants: {
			size: {
				sm: '',
	...
	<Section className="relative w-full pt-10">
		<div className="flex flex-col gap-10">
			<div className="flex flex-col gap-2 px-6">
				...
				<p className="max-w-xl text-left text-lg leading-relaxed tracking-tight text-foreground-muted lg:max-w-lg">
