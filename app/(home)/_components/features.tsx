  ...
  <Section className="relative w-full pt-10">
    <div className="flex flex-col gap-10">
      <div className="flex flex-col gap-2 px-6">
        ...
        <p className="text-foreground-muted max-w-xl text-left text-lg leading-relaxed tracking-tight lg:max-w-lg">
      ...
      <div className="border-border w-full border-t border-dashed">
        <div className="divide-border grid grid-cols-1 divide-x divide-y divide-dashed text-left sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="text-foreground-muted max-w-xs text-base">
                  {feature.description}
                </p>
              </div>
            </div>
