	...
	'not-prose transition-all duration-200 ease-in-out',
	{
		variants: {
			variant: {
				...
				card: 'rounded-lg [&:has(:focus-visible)]:ring-1 [&:has(:focus-visible)]:ring-ring [&:has(:focus-visible)]:ring-offset-2 [&:has(:focus-visible)]:ring-offset-ring-offset/50 [&:has(:focus-visible)]:outline-none',
			},
			isOpen: {
				true: '',
				false: '',
...
const accordionTriggerVariants = cva(
	'not-prose flex w-full items-center justify-between rounded-lg text-left transition-all duration-200 ease-in-out focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none',
	{
		variants: {
			variant: {
...
const accordionContentVariants = cva(
	'not-prose overflow-hidden transition-all duration-200 ease-in-out',
	{
		variants: {
			size: {
				sm: 'text-xs',
			...
			return (
				<AccordionItemContext.Provider value={contextValue}>
					<div
						...
						{...props}
					>
						<div className="not-prose relative overflow-hidden rounded-lg border border-none border-border bg-background shadow-sm transition-all duration-200 ease-in-out dark:border-solid">
							{children}
						</div>
					</div>
