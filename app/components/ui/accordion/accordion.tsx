...
const accordionTriggerVariants = cva(
	'not-prose flex w-full items-center justify-between rounded-lg text-left transition-all duration-200 ease-in-out focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none',
	{
		variants: {
			variant: {
			...
			return (
				<AccordionItemContext.Provider value={contextValue}>
					<div
						...
						{...props}
					>
						<div className="not-prose relative overflow-hidden rounded-lg border border-none border-border bg-card shadow-sm transition-all duration-200 ease-in-out dark:border-solid">
							{children}
						</div>
					</div>
