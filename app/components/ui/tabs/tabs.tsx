...
const tabsListVariants = cva(
	'not-prose inline-flex items-center justify-center transition-all duration-200 ease-in-out',
	{
		variants: {
			...
			variant: {
				default:
					'rounded-lg border border-none border-border bg-background shadow-sm dark:border-solid',
				pills: 'gap-1',
				underline: 'border-muted gap-0 border-b',
			},
			size: {
				sm: '',
				md: '',
...
const tabsTriggerVariants = cva(
	`not-prose not-prose inline-flex cursor-pointer items-center justify-center font-medium whitespace-nowrap transition-all duration-200 ease-in-out focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50`,
	{
		variants: {
			variant: {
				default: `w-full rounded-md text-foreground-muted hover:text-foreground data-[active-item]:bg-background-muted data-[active-item]:text-foreground data-[active-item]:shadow-sm`,
				pills: `rounded-lg text-foreground-muted hover:bg-background hover:text-foreground data-[active-item]:bg-foreground-muted data-[active-item]:text-background data-[active-item]:shadow-sm`,
				underline: `border-muted border-b-2 border-transparent text-foreground-muted hover:text-foreground data-[active-item]:border-foreground-muted data-[active-item]:text-foreground`,
			},
			size: {
				sm: '',
				md: '',
