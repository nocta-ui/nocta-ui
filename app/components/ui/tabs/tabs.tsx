...
export function TabsContent({ children, value, className }: TabsContentProps) {
  return (
    <Ariakit.TabPanel
      tabId={value}
      className={cn(
        'focus-visible:ring-offset-ring-offset/50 not-prose focus-visible:ring-ring/50 focus-visible:border-border focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none',
        className
      )}
    >
      {children}
