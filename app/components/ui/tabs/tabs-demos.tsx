...
export const VariantsDemo: React.FC = () => {
  return (
    <div className="my-6 w-72 space-y-8">
      {/* Default variant */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Default</h4>
      ...
      {/* Pills variant */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Pills</h4>
      ...
      {/* Underline variant */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Underline</h4>
...
export const SizesDemo: React.FC = () => {
  return (
    <div className="my-6 w-64 space-y-8">
      {/* Small size */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Small</h4>
        <Tabs defaultValue="tab1" size="sm">
          ...
          <TabsContent value="tab1" className="mt-4">
            <p className="text-foreground-muted text-sm">Small tab content.</p>
          </TabsContent>
          <TabsContent value="tab2" className="mt-4">
            <p className="text-foreground-muted text-sm">Small tab content.</p>
          </TabsContent>
      ...
      {/* Medium size */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Medium</h4>
        <Tabs defaultValue="tab1" size="md">
          ...
          <TabsContent value="tab1" className="mt-4">
            <p className="text-foreground-muted text-sm">Medium tab content.</p>
          </TabsContent>
          <TabsContent value="tab2" className="mt-4">
            <p className="text-foreground-muted text-sm">Medium tab content.</p>
          </TabsContent>
      ...
      {/* Large size */}
      <div>
        <h4 className="text-foreground mb-3 text-sm font-medium">Large</h4>
        <Tabs defaultValue="tab1" size="lg">
          ...
          <TabsContent value="tab1" className="mt-4">
            <p className="text-foreground-muted text-sm">Large tab content.</p>
          </TabsContent>
          <TabsContent value="tab2" className="mt-4">
            <p className="text-foreground-muted text-sm">Large tab content.</p>
          </TabsContent>
