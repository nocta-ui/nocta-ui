...
const wheelPickerFocusRingClasses =
	'group-focus/wheelpicker:rounded-sm group-focus/wheelpicker:ring-1 group-focus/wheelpicker:ring-ring/50 group-focus/wheelpicker:ring-offset-1 group-focus/wheelpicker:ring-offset-ring-offset/50 group-focus-visible/wheelpicker:rounded-sm group-focus-visible/wheelpicker:border-border group-focus-visible/wheelpicker:ring-1 group-focus-visible/wheelpicker:ring-ring/50 group-focus-visible/wheelpicker:ring-offset-1 group-focus-visible/wheelpicker:ring-offset-ring-offset/50 transition-shadow duration-150 ease-basic';
	...
	return (
		<WheelPickerGroupContext.Provider value={contextValue}>
			<div
				{...props}
				className={cn(
					'not-prose relative isolate flex overflow-hidden rounded-md border border-border bg-card shadow-sm',
...
export const WheelPicker: React.FC<WheelPickerProps> = ({
	...
	const rootClassName = grouped
		? cn(
				'not-prose relative isolate flex-none min-w-0 overflow-hidden bg-transparent shadow-none',
