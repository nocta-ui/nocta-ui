  ...
  return (
    <div className="flex items-center">
      <Avatar
        src="https://raw.githubusercontent.com/origin-space/origin-images/refs/heads/main/exp2/user-02_mlqqqt.png"
        alt="John Doe"
        className="ring-ring-offset ring-1"
      />
      <Avatar
        src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
        alt="Jane Smith"
        className="ring-ring-offset -ml-2 ring-1"
      />
      <Avatar
        src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
        alt="Mike Johnson"
        className="ring-ring-offset -ml-2 ring-1"
      />
      <Avatar fallback="AB" className="ring-ring-offset -ml-2 ring-1" />
      <div className="bg-background ring-ring-offset text-foreground-muted -ml-2 flex h-10 w-10 items-center justify-center rounded-full text-xs font-medium ring-1">
        +5
      </div>
    </div>
  )
...
export const CustomStylingDemo: React.FC = () => {
  return (
    <div className="my-6 flex items-center gap-4">
      ...
      <Avatar
        fallback="JD"
        className="text-background bg-gradient-to-br from-purple-500 to-pink-500"
      />
      <Avatar
        src="https://raw.githubusercontent.com/origin-space/origin-images/refs/heads/main/exp2/user-02_mlqqqt.png"
        alt="John Doe"
...
export const ClickHandlersDemo: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {message && (
        <div className="text-success/90 text-sm font-medium">{message}</div>
      )}
    </div>
  )
}
