...
export const GroupDemo: React.FC = () => {
	return (
		<div className="flex items-center">
			...
			<div className="-ml-2 flex h-10 w-10 items-center justify-center rounded-full bg-background text-xs font-medium text-foreground-muted ring-1 ring-ring-offset">
				+5
			</div>
		</div>
	);
