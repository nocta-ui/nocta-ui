...
const popoverContentVariants = cva(
	'not-prose relative w-fit max-w-[var(--popover-available-width,_theme(spacing.80))] min-w-[8rem] overflow-hidden rounded-lg border border-none border-border bg-background-muted p-4 text-foreground shadow-md dark:border-solid',
	{
		variants: {
			size: {
				sm: 'p-2 text-sm',
