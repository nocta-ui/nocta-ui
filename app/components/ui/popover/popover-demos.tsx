		...
		<div className="my-6 space-y-4">
			<div className="flex justify-center gap-2">
				<button
					...
					className="rounded border border-success/40 bg-success/10 px-3 py-1 text-sm text-success/90 duration-150 ease-in-out hover:opacity-80"
				>
					Open
				</button>
				<button
					...
					<PopoverContent>
						<div className="flex flex-col space-y-2">
							...
							<button
								type="button"
								onClick={() => setOpen(false)}
								className="rounded bg-card px-2 py-1 text-xs duration-150 ease-in-out hover:bg-foreground/60/10"
							>
								Close from inside
							</button>
						</div>
