...
export function SizesDemo() {
  return (
    <div className="space-y-4">
      ...
      <div>
        <p className="text-sm text-nocta-600 dark:text-nocta-400 mb-2">Medium (Default)</p>
        <Breadcrumb size="md">
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="/">Home</BreadcrumbLink>
  ...
  return (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbLink href="/products/category" variant="ghost">Category</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
        <BreadcrumbItem>
