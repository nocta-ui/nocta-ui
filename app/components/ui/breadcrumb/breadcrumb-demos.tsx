	...
	return (
		<div className="my-6">
			<div className="space-y-8">
				<div>
					<p className="mb-2 text-sm text-foreground-muted">Small</p>
					<Breadcrumb size="sm">
						<BreadcrumbList>
							<BreadcrumbItem>
								<BreadcrumbLink href="/">Home</BreadcrumbLink>
				...
				<div>
					<p className="mb-2 text-sm text-foreground-muted">Medium (Default)</p>
					<Breadcrumb size="md">
						<BreadcrumbList>
							<BreadcrumbItem>
								<BreadcrumbLink href="/">Home</BreadcrumbLink>
				...
				<div>
					<p className="mb-2 text-sm text-foreground-muted">Large</p>
					<Breadcrumb size="lg">
						<BreadcrumbList>
							<BreadcrumbItem>
								<BreadcrumbLink href="/">Home</BreadcrumbLink>
