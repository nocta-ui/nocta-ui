  ...
  return (
    <div className="my-6">
      <div className="space-y-8">
        <div>
          <p className="text-foreground-muted mb-2 text-sm">Small</p>
          <Breadcrumb size="sm">
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/">Home</BreadcrumbLink>
        ...
        <div>
          <p className="text-foreground-muted mb-2 text-sm">Medium (Default)</p>
          <Breadcrumb size="md">
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/">Home</BreadcrumbLink>
        ...
        <div>
          <p className="text-foreground-muted mb-2 text-sm">Large</p>
          <Breadcrumb size="lg">
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/">Home</BreadcrumbLink>
