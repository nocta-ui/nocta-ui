...
const breadcrumbLinkVariants = cva(
	[
		'inline-flex items-center transition-[background-color,box-shadow,color,text-decoration-color] duration-100 ease-basic',
...
const breadcrumbPageVariants = cva('font-medium text-foreground', {
	variants: {
		size: {
			sm: 'text-xs',
			md: 'text-sm',
...
const breadcrumbSeparatorVariants = cva('text-foreground/45 select-none', {
	variants: {
		size: {
			sm: 'text-xs',
			md: 'text-sm',
