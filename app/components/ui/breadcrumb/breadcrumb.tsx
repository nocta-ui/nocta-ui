...
export const BreadcrumbLink: React.FC<BreadcrumbLinkProps> = ({
  ...
  if (asChild) {
    return (
      <span className={cn(breadcrumbLinkVariants({ variant, size: effectiveSize }), className)}>
        {children}
      </span>
    );
  }
  ...
  return (
    <a
      className={cn(breadcrumbLinkVariants({ variant, size: effectiveSize }), className)}
      {...props}
    >
      {children}
    </a>
...
export const BreadcrumbSeparator: React.FC<BreadcrumbSeparatorProps> = ({
  ...
  return (
    <li
      role="presentation"
      aria-hidden="true"
      className={cn(breadcrumbSeparatorVariants({ size: effectiveSize }), className)}
      {...props}
    >
      {separator}
    </li>
