...
import React, { forwardRef, useRef, ReactNode, HTMLAttributes, CSSProperties } from 'react';
    ...
    return (
      ...
      >
        ...
        <div
          ...
          {...viewportProps}
          className={cn(
            'text-[13px] py-3.5 overflow-auto bg-neutral-200 dark:bg-neutral-900 m-1 rounded-md border [&_.line]:px-4 max-h-[600px] fd-scroll-container',
