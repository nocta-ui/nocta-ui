    ...
    return (
      ...
      >
        ...
        <div
          ...
          {...viewportProps}
          className={cn(
            'bg-fd-background border-border fd-scroll-container m-1 max-h-[600px] overflow-auto rounded-lg border border-dashed py-3.5 text-[13px] [&_.line]:px-4',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:bg-background-muted/50 hover:text-foreground-subtle',
