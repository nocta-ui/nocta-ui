  ...
  return (
    <div className="my-6 space-y-6">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-error/90 text-xs">Please select an option</p>
      </div>
      ...
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-success/90 text-xs">Looks good!</p>
      </div>
    </div>
  )
}
...
export const SizesDemo: React.FC = () => {
  return (
    <div className="my-6 space-y-4">
      <div>
        <label className="text-foreground-muted mb-1.5 block text-sm font-medium">
          Small
        </label>
        <Select size="sm">
          <SelectTrigger className="w-[180px]">
