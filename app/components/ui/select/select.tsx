...
const selectTriggerVariants = cva(
	`not-prose not-prose flex w-fit cursor-pointer items-center justify-between rounded-md border shadow-sm transition-all duration-150 ease-out placeholder:text-foreground/45 hover:bg-card-muted focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50`,
	{
		variants: {
			variant: {
...
export const SelectItem: React.FC<SelectItemProps> = ({
	...
	return (
		<Ariakit.SelectItem
			...
			disabled={disabled}
			className={cn(
				'relative mx-1 flex cursor-pointer items-center justify-between rounded-sm px-3 py-2 text-sm text-foreground/70 transition-colors duration-150 ease-out outline-none select-none hover:bg-card-muted hover:text-foreground data-active-item:bg-card-muted data-active-item:text-foreground',
