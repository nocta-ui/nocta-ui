...
const selectTriggerVariants = cva(
	`not-prose not-prose flex w-fit cursor-pointer items-center justify-between rounded-md border border-none shadow-sm transition-all duration-200 ease-in-out placeholder:text-foreground-subtle hover:bg-background-muted/50 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-solid`,
	{
		variants: {
			variant: {
	...
	return (
		<Ariakit.SelectItem
			...
			className={cn(
				...
				isSelected && 'bg-background-muted font-medium text-foreground',
	...
	return (
		...
		>
			{currentItem ? (
				...
				<span className="whitespace-pre-wrap text-foreground-subtle">
					{placeholder}
				</span>
			)}
		</span>
