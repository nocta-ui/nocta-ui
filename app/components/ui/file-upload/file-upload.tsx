...
export const FileUploadProgress: React.FC<FileUploadProgressProps> = ({
	...
	return (
		<div
			className={cn('h-2 w-full rounded-full bg-background-muted', className)}
		>
			<div
		...
		>
			...
			<div className="min-w-0 flex-1">
				...
				<div className="mt-1 flex min-w-0 items-center gap-2">
					<p className="flex-shrink-0 text-xs text-foreground-muted">
					...
					<div className="flex items-center justify-between">
						...
						{(pendingFiles.length > 0 || isUploading) && onUpload && (
							<Button
								...
								size="sm"
								variant="ghost"
								className="bg-foreground text-background transition-colors duration-200 hover:bg-foreground-muted hover:text-background/80"
