        ...
        >
          <div className={cn(toastContentVariants({ variant }))}>
            <button
              ...
              onClick={handleClose}
              className={cn(
                'text-foreground-subtle hover:text-foreground-muted focus-visible:ring-ring/50 absolute top-2 right-2 cursor-pointer rounded-md p-1 transition-colors duration-200 focus-visible:ring-1 focus-visible:outline-none'
              )}
            ...
            <div className="p-4 pr-8">
              ...
              {description && (
                <div
                  id={descriptionId}
                  className="text-foreground-muted/80 text-sm leading-relaxed opacity-80"
                >
                  {description}
                </div>
              )}
              {action && (
                <div className="mt-3">
                  <button
                    ...
                    className="bg-foreground hover:bg-foreground-muted text-background focus-visible:ring-ring/50 inline-flex cursor-pointer items-center justify-center rounded-md px-3 py-1.5 text-sm font-medium shadow-sm transition-all duration-200"
                  >
                    {action.label}
                  </button>
                </div>
