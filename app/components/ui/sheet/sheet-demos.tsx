      ...
      <Sheet>
        ...
        <SheetContent resizable size="lg">
          ...
          <div className="flex-1 space-y-3 p-4">
            ...
            <div className="border-border-muted bg-background text-foreground-muted/80 rounded-lg border p-3 text-xs">
        ...
        <SheetContent>
          ...
          <div className="flex-1 space-y-4 p-4">
            ...
            <div className="flex flex-col space-y-2">
              <div className="text-foreground-muted block text-sm font-medium">
                Status
              </div>
