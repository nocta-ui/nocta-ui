...
const sheetContentVariants = cva(
	'fixed flex transform flex-col border border-none border-border bg-background shadow-2xl transition-transform duration-200 ease-in-out dark:border-solid',
	{
		variants: {
			side: {
...
export const SheetTrigger: React.FC<SheetTriggerProps> = ({
	...
	return (
		<button
			className={cn(
				'not-prose not-prose inline-flex cursor-pointer items-center justify-center rounded-md font-medium transition-all duration-200 ease-in-out focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none',
				className,
			)}
			type="button"
			onClick={handleClick}
...
export const SheetContent: React.FC<SheetContentProps> = ({
	...
	return (
		...
		>
				...
				(side === 'left' || side === 'right') && (
					...
					>
						<hr
							...
							className="not-prose absolute inset-0 m-0 h-full w-full rounded-[2px] border-none bg-transparent focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none"
						/>
						<div className="pointer-events-none flex h-8 w-2 flex-col items-center justify-center rounded-[2px] bg-border-muted">
				...
				(side === 'top' || side === 'bottom') && (
					...
					>
						<hr
							...
							className="not-prose absolute inset-0 m-0 h-full w-full rounded-[2px] border-none bg-transparent focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none"
						/>
						<div className="pointer-events-none flex h-2 w-8 items-center justify-center rounded-[2px] bg-border-muted">
			...
			{showClose && (
				<AriakitDialogDismiss className="not-prose absolute top-1 right-1 z-10 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-md text-foreground-subtle transition-colors duration-200 hover:bg-background hover:text-foreground-muted focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none">
...
export const SheetFooter: React.FC<SheetFooterProps> = ({
	...
	return (
		<div
			className={cn(
				'not-prose mt-auto flex items-center justify-end gap-3 border-t border-border/60 bg-background-muted/50 p-4 dark:bg-background-muted/30',
				className,
			)}
			{...props}
		>
...
export const SheetClose: React.FC<SheetCloseProps> = ({
	...
	return (
		<AriakitDialogDismiss
			store={store}
			className={cn(
				'inline-flex cursor-pointer items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium text-foreground hover:bg-background-muted/60 focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none',
				className,
			)}
			type="button"
			onClick={onClick}
