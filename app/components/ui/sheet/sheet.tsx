...
const sheetContentVariants = cva(
  "fixed flex transform flex-col border border-none border-border bg-card shadow-2xl transition-transform duration-200 ease-in-out dark:border-solid",
  {
    variants: {
      side: {
...
export const SheetContent: React.FC<SheetContentProps> = ({
  ...
  return (
    ...
    >
      {resizable &&
        ...
        (side === "left" || side === "right") && (
          ...
          >
            ...
            />
            <div className="z-10 pointer-events-none flex h-8 w-2 flex-col items-center justify-center rounded-[2px] bg-border-muted">
      ...
      {resizable &&
        ...
        (side === "top" || side === "bottom") && (
          ...
          >
            ...
            />
            <div className="z-10 pointer-events-none flex h-2 w-8 items-center justify-center rounded-[2px] bg-border-muted">
      ...
      {showClose && (
        <AriakitDialogDismiss className="not-prose absolute top-1 right-1 z-10 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-md text-foreground/45 transition-colors duration-200 hover:bg-card-muted hover:text-foreground/70 focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none">
...
export const SheetClose: React.FC<SheetCloseProps> = ({
  ...
  return (
    <AriakitDialogDismiss
      store={store}
      className={cn(
        "inline-flex cursor-pointer items-center justify-center rounded-md bg-transparent transition-colors duration-200 px-4 py-2 text-sm font-medium text-foreground hover:bg-card-muted/60 focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none",
        className,
      )}
      type="button"
      onClick={onClick}
