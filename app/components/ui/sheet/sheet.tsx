...
export const SheetTrigger: React.FC<SheetTriggerProps> = ({
  ...
  return (
    <button
      className={cn(
        'focus-visible:ring-offset-ring-offset/50 not-prose focus-visible:ring-ring/50 focus-visible:border-border not-prose inline-flex cursor-pointer items-center justify-center rounded-md font-medium transition-all duration-200 ease-in-out focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none',
        className
      )}
      type="button"
      onClick={handleClick}
...
export const SheetContent: React.FC<SheetContentProps> = ({
  ...
  return (
    ...
    >
        ...
        (side === 'left' || side === 'right') && (
          ...
          >
            <hr
              ...
              className="focus-visible:ring-offset-ring-offset/50 not-prose focus-visible:ring-ring/50 focus-visible:border-border absolute inset-0 m-0 h-full w-full rounded-[2px] border-none bg-transparent focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none"
            />
            <div className="bg-border-muted pointer-events-none flex h-8 w-2 flex-col items-center justify-center rounded-[2px]">
              <div className="flex flex-col gap-1">
                <span className="bg-foreground/60 h-0.5 w-0.5 rounded-full"></span>
                <span className="bg-foreground/60 h-0.5 w-0.5 rounded-full"></span>
                <span className="bg-foreground/60 h-0.5 w-0.5 rounded-full"></span>
              </div>
            </div>
        ...
        (side === 'top' || side === 'bottom') && (
          ...
          >
            <hr
              ...
              className="focus-visible:ring-offset-ring-offset/50 not-prose focus-visible:ring-ring/50 focus-visible:border-border absolute inset-0 m-0 h-full w-full rounded-[2px] border-none bg-transparent focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none"
            />
            <div className="bg-border-muted pointer-events-none flex h-2 w-8 items-center justify-center rounded-[2px]">
      ...
      {showClose && (
        <AriakitDialogDismiss className="text-foreground-subtle hover:text-foreground-muted hover:bg-background focus-visible:ring-offset-ring-offset/50 not-prose focus-visible:ring-ring/50 focus-visible:border-border absolute top-1 right-1 z-10 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-md transition-colors duration-200 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none">
...
export const SheetFooter: React.FC<SheetFooterProps> = ({
  ...
  return (
    <div
      className={cn(
        'bg-background-muted/50 dark:bg-background-muted/30 border-border-muted not-prose mt-auto flex items-center justify-end gap-3 border-t p-4',
        className
      )}
      {...props}
    >
...
export const SheetClose: React.FC<SheetCloseProps> = ({
  ...
  return (
    <AriakitDialogDismiss
      store={store}
      className={cn(
        'text-foreground hover:bg-background-muted/60 focus-visible:ring-offset-ring-offset/50 focus-visible:ring-ring/50 inline-flex cursor-pointer items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none',
        className
      )}
      type="button"
      onClick={onClick}
