...
const dialogContentVariants = cva(
	`not-prose relative max-h-[70vh] overflow-y-auto rounded-lg border border-border bg-card shadow-2xl transition-all duration-150 ease-out`,
	{
		variants: {
			size: {
...
export const DialogTrigger: React.FC<DialogTriggerProps> = ({
	...
	return (
		<button
			className={cn(
				'not-prose not-prose inline-flex items-center justify-center rounded-lg font-medium transition-all duration-150 ease-out focus-visible:border-border focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none',
				className,
			)}
			onClick={handleClick}
			aria-haspopup="dialog"
	...
	return (
		<AriakitDialog
			...
			className={cn(
				...
				'scale-105 opacity-0 blur-sm transition-all duration-150 ease-out',
