...
const inputVariants = cva(
	[
		'flex w-fit rounded-lg border border-none transition-all duration-200 ease-in-out dark:border-solid',
...
const iconVariants = cva(
	['absolute top-1/2 -translate-y-1/2 transform', 'text-foreground-subtle'],
	{
		variants: {
			position: {
				left: 'left-3',
