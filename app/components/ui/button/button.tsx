...
export const buttonVariants = cva(
	'not-prose relative inline-flex cursor-pointer items-center justify-center rounded-md font-medium transition-all duration-200 ease-in-out focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
	{
		variants: {
			variant: {
				primary:
					'relative bg-foreground/90 hover:bg-foreground/75 text-background shadow-sm focus-visible:border-border focus-visible:ring-ring/50 before:content-[""] before:absolute before:inset-[1px] before:rounded-[calc(theme(borderRadius.md)-1px)] before:border-[0.5px] before:border-background/25 before:pointer-events-none',
				secondary:
