...
export const buttonVariants = cva(
	"not-prose relative inline-flex cursor-pointer items-center justify-center rounded-md font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 transition-[background-color,filter,box-shadow] duration-150 ease-basic focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-ring-offset/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
	{
		variants: {
			variant: {
				default:
				...
				secondary:
					'border border-border bg-card text-foreground shadow-sm hover:bg-card-muted focus-visible:ring-ring/50',
				ghost: 'text-foreground hover:bg-card-muted focus-visible:ring-ring/50',
				icon: 'text-foreground hover:bg-card-muted focus-visible:ring-ring/50',
			},
			size: {
