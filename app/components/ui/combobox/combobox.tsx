...
const comboboxVariants = cva(
  `relative w-fit inline-flex items-center justify-between
   ...
   rounded-md border border-none dark:border-solid transition-all duration-200 ease-in-out
    ...
    <Ariakit.ComboboxProvider resetValueOnHide>
      <Ariakit.MenuProvider store={menu}>
        <div className="not-prose relative">
            ...
            <div className="ml-2 flex items-center gap-1">
              {clearable && selectedOption && !disabled && (
                <span
                  ...
                  role="button"
                  tabIndex={0}
                  className="hover:bg-background text-foreground-subtle hover:text-foreground-muted cursor-pointer rounded p-0.5 duration-200 ease-in-out"
              ...
              <Icons.CaretSort
                aria-hidden="true"
                className="text-foreground-subtle h-4.5 w-4.5"
              />
            </div>
          </Ariakit.MenuButton>
          ...
          >
            <div className="border-border-muted border-b p-1">
              <Ariakit.Combobox
                autoSelect
                ...
                className="placeholder:text-foreground-subtle w-full border-0 bg-transparent px-3 py-2 text-sm focus-visible:outline-none"
              />
            </div>
            ...
            >
              ...
              {matches.length === 0 ? (
                <output
                  aria-live="polite"
                  className="text-foreground-muted mx-1 px-3 py-2 text-center text-sm"
                >
                  {emptyMessage}
                </output>
              ) : (
