		...
		compoundVariants: [
			{
				checked: true,
				class:
					'border-border bg-foreground-muted has-[:focus-visible]:ring-ring/50',
			},
			{
				checked: false,
				class:
					'border-border bg-background-muted has-[:focus-visible]:ring-ring/50',
			},
		],
		defaultVariants: {
			size: 'md',
...
const iconVariants = cva(
	['text-background transition-opacity duration-200 ease-in-out'],
	{
		variants: {
			size: {
				sm: 'h-3 w-3',
