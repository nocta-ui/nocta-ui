		...
		return (
			<button
				...
				className={cn(
					...
					isActive
						? "bg-nocta-100 dark:bg-nocta-950/50 text-fd-foreground shadow-sm ring-1 ring-fd-border/20"
		...
		<div className="not-prose group relative my-4 rounded-lg border bg-nocta-200 dark:bg-nocta-900 text-sm outline-none">
			...
			>
				...
				<div
					ref={wrapperRef}
					className={cn(
						"p-4  rounded-md border transition-opacity duration-150 ease-in-out relative",
