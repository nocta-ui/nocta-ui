	...
	return (
		<div className="not-prose group relative text-sm outline-none z-0 mb-16">
			...
			<div ref={contentRef} className="relative">
				{activeTab !== "code" && (
					<div className="absolute inset-2 border border-border rounded-lg border-dashed bg-fd-background z-0"></div>
				)}
				<div
					ref={wrapperRef}
				...
				>
					<div
						className={`w-full flex justify-${justify} md:justify-center items-center overflow-x-auto ${activeTab !== "code" ? "p-4 md:p-8" : ""} ${activeTab === "code" ? " -mb-16" : ""}`}
					>
