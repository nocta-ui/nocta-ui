    ...
    >
      {table.getHeaderGroups().map((headerGroup) => (
        ...
        <div
          key={headerGroup.id}
          role="row"
          className="bg-background-muted/50 dark:bg-background-muted/30 border-border-muted grid border-b"
      ...
      <Ariakit.Composite
        ...
        className="focus-visible:ring-offset-ring-offset/50 focus-visible:ring-ring/50 rounded-lg focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none"
      >
        {rows.length === 0 && (
          <div className="text-foreground-muted px-6 py-10 text-center">
