...
const ViteLogo = () => (
  <svg
    ...
    className="text-foreground-subtle h-16 w-16"
    fill="currentColor"
  >
    <title>Vite</title>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        {frameworks.map((framework) => (
          ...
          >
            ...
            >
              <div className="border-border bg-background hover:bg-background-muted/50 hover:text-foreground-muted flex h-full w-full flex-col items-center justify-center gap-4 rounded-md border border-none p-8 shadow-sm transition-colors duration-300 dark:border-solid">
                {framework.logo}
                <div className="mt-3">
                  <span className="text-foreground-muted block text-lg font-medium">
                    {framework.name}
                  </span>
                  <span className="text-foreground-subtle dark:text-foreground-subtle block text-sm">
