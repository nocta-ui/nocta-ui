			...
			<div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
				{frameworks.map((framework) => (
					...
					>
						...
						>
							<div className="flex h-full w-full flex-col items-center justify-center gap-4 rounded-md border border-none border-border bg-background p-8 shadow-sm transition-colors duration-300 hover:bg-background-muted/50 hover:text-foreground-muted dark:border-solid">
								{framework.logo}
								<div className="mt-3">
