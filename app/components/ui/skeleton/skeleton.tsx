...
const skeletonVariants = cva('not-prose bg-card-muted', {
	variants: {
		variant: {
			default: '',
			shimmer:
				"relative overflow-hidden after:absolute after:inset-0 after:animate-[shimmer_2s_ease-basic_infinite] after:bg-[linear-gradient(90deg,transparent_0%,rgba(0,0,0,0.05)_50%,transparent_100%)] after:content-[''] dark:after:bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.05)_50%,transparent_100%)]",
		},
		shape: {
			rectangle: 'rounded',
			circle: 'rounded-full',
