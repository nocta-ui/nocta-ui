    ...
    compoundVariants: [
      {
        variant: 'default',
        checked: true,
        class: 'bg-nocta-400 dark:bg-nocta-600 focus-visible:ring-nocta-900/50 dark:focus-visible:ring-nocta-100/50'
      },
      {
        variant: 'default',
        checked: false,
      ...
      },
      {
        variant: 'success',
        checked: true,
        class: 'bg-green-500 dark:bg-green-600/50 focus-visible:ring-green-500/50'
      },
      {
        variant: 'success',
        checked: false,
      ...
      },
      {
        variant: 'warning',
        checked: true,
        class: 'bg-yellow-500 dark:bg-yellow-600/50 focus-visible:ring-yellow-500/50'
      },
      {
        variant: 'warning',
        checked: false,
        class: 'bg-nocta-200 dark:bg-nocta-800 focus-visible:ring-yellow-500/50'
      },
      {
        variant: 'destructive',
        checked: true,
...
export const Switch: React.FC<SwitchProps> = ({
  ...
  return (
    <label
      className={cn(switchVariants({ variant, size, checked, disabled }), className)}
      htmlFor={id}
    >
      <input
        type="checkbox"
