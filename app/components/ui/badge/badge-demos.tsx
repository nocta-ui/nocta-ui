...
export const CustomStylingDemo: React.FC = () => {
  return (
    <div className="my-6 flex flex-wrap gap-3">
      <Badge className="text-background dark:text-foreground bg-linear-to-r from-purple-500 to-pink-500 dark:from-purple-500 dark:to-pink-500">
        Gradient
      </Badge>
      <Badge
        variant="secondary"
        className="text-background dark:text-foreground bg-blue-500 shadow-sm dark:bg-blue-500/50"
      >
        Custom Color
      </Badge>
