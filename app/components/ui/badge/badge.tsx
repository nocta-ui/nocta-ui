		...
		variants: {
			variant: {
				default: [
					...
					'before:content-[""] before:absolute before:inset-[1px] before:rounded-[calc(theme(borderRadius.full)-0.5px)] before:border-[0.5px] before:border-background/35 before:pointer-events-none',
				],
				secondary: [
					'bg-card',
					'text-foreground',
