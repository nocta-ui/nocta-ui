...
const tooltipContentVariants = cva(
	`z-50 px-3 py-2 text-sm border rounded-lg shadow-sm pointer-events-auto not-prose overflow-hidden
...
export const TooltipTrigger: React.FC<TooltipTriggerProps> = ({
	...
	return (
		<TooltipAnchor
			className={cn("inline-flex items-center not-prose", className)}
			{...props}
		>
			{children}
		</TooltipAnchor>
