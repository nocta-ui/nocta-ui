...
const contextMenuContentVariants = cva(
	`not-prose z-50 origin-top -translate-y-1 scale-95 transform overflow-hidden rounded-md border border-none border-border bg-background text-foreground-muted opacity-0 shadow-md transition-all duration-200 ease-in-out data-[enter]:translate-y-0 data-[enter]:scale-100 data-[enter]:opacity-100 data-[leave]:-translate-y-1 data-[leave]:scale-95 data-[leave]:opacity-0 dark:border-solid`,
	{
		variants: {
			size: {
				sm: 'min-w-[8rem] p-1',
...
const contextSubMenuContentVariants = cva(
	`not-prose z-50 origin-top-left -translate-y-1 scale-95 transform rounded-md border border-none border-border bg-background text-foreground opacity-0 shadow-md transition-all duration-200 data-[enter]:translate-y-0 data-[enter]:scale-100 data-[enter]:opacity-100 data-[leave]:-translate-y-1 data-[leave]:scale-95 data-[leave]:opacity-0 dark:border-solid`,
	{
		variants: {
			size: {
				sm: 'min-w-[7rem] p-1',
...
const contextMenuItemVariants = cva(
	`relative flex w-full cursor-pointer items-center rounded-sm px-3 py-2 text-sm transition-colors outline-none select-none hover:bg-background-muted hover:text-foreground focus-visible:bg-background-muted focus-visible:text-foreground aria-disabled:pointer-events-none aria-disabled:opacity-50`,
	{
		variants: {
			inset: {
				true: 'pl-8',
