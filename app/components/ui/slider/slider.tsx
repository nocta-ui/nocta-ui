...
const trackVariants = cva(
  "relative overflow-hidden rounded-full border border-none border-border/60 bg-card-muted shadow-inner dark:border-solid",
  {
    variants: {
      size: {
        sm: "h-1 w-full",
...
const thumbVariants = cva(
  "absolute origin-center transform rounded-full shadow-md hover:shadow-sm",
  {
    variants: {
      variant: {
        default: "border-muted/50 border bg-foreground",
