...
const sliderVariants = cva(
	'not-prose relative cursor-pointer touch-none rounded-full select-none focus:outline-none focus-visible:ring-1 focus-visible:ring-offset-2 focus-visible:ring-offset-ring-offset/50 disabled:cursor-not-allowed disabled:opacity-50',
	{
		variants: {
			orientation: {
				horizontal: 'w-full',
...
const trackVariants = cva(
	'relative overflow-hidden rounded-full border border-none border-border/60 bg-background-muted shadow-inner dark:border-solid',
	{
		variants: {
			size: {
				sm: 'h-1 w-full',
...
const thumbVariants = cva(
	'absolute origin-center transform rounded-full shadow-md hover:shadow-sm',
	{
		variants: {
			variant: {
				default:
					'border-muted/50 border bg-foreground-muted dark:bg-foreground',
				secondary: 'border border-border bg-background-muted',
			},
			size: {
				sm: 'h-4 w-4',
				md: 'h-5 w-5',
