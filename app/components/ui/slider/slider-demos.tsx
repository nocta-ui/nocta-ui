    ...
    <div className="my-6">
      <div className="flex items-center gap-8">
        <div className="flex h-48 flex-col items-center gap-2">
          ...
          />
          <span className="text-foreground-muted text-xs">Default</span>
        </div>
        <div className="flex h-48 flex-col items-center gap-2">
          <Slider
            orientation="vertical"
          ...
          />
          <span className="text-foreground-muted text-xs">Secondary Large</span>
        </div>
      </div>
    </div>
  )
    ...
    <div className="my-6 w-48">
      <div className="bg-background rounded-lg p-4">
        <div className="space-y-4">
          ...
          />
          <div className="text-foreground-subtle dark:text-foreground-subtle flex justify-between text-xs">
            <span>$500</span>
            <span>$10,000</span>
          </div>
        </div>
