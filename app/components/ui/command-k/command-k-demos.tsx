...
const IconFolder = (
  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h5l2 2h11v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
  </svg>
);
...
export const BasicCommandKDemo: React.FC = () => {
  ...
  const items: CommandKItem[] = [
    { label: "Search docs", group: "Navigation", description: "Go to documentation", icon: IconSearch, shortcut: ["S"] },
    { label: "Open settings", group: "Navigation", description: "Application preferences", icon: IconCog, shortcut: ["O"] },
    { label: "New file", group: "Actions", description: "Create an untitled file", icon: IconFile, shortcut: ["Shift", "F"] },
    { label: "New folder", group: "Actions", description: "Create a folder", icon: IconFolder, shortcut: ["Shift", "G"] },
  ];
  ...
  return (
    <div className="my-6 flex items-center gap-3">
      ...
      <CommandK
        ...
        size="sm"
        onSelect={(it) => {
          toast.success({ title: "Command executed", description: `Selected: ${it.label}` });
        }}
      />
    </div>
  );
