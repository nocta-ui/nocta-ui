...
const groupHeaderClass = cva(
	'px-3 pt-2 pb-1 text-xs font-medium tracking-wide text-foreground-subtle/90',
);
											...
											>
												...
												<div className="flex min-w-0 flex-1 flex-row gap-3">
													...
													{entry.item.description && (
														<div className="mt-0.5 hidden truncate text-xs text-foreground-muted/80 md:block">
															{entry.item.description}
														</div>
													)}
												</div>
