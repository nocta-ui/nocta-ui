  ...
  useEffect(() => {
    const onKeyDown = (e: KeyboardEvent) => {
      ...
      if (!requiresMeta && !requiresCtrl) {
        ...
        modifierOk =
          (requiresMeta ? e.metaKey : true) && (requiresCtrl ? e.ctrlKey : true)
      }
                      ...
                      >
                        ...
                        <div className="flex min-w-0 flex-1 flex-row gap-3">
                          ...
                          {entry.item.description && (
                            <div className="text-foreground-muted/80 mt-0.5 hidden truncate text-xs md:block">
                              {entry.item.description}
                            </div>
                          )}
                        </div>
