...
export const SizesDemo: React.FC = () => {
	return (
		<div className="my-6 w-64 space-y-4">
			<div>
				<span className="mb-2 block text-sm text-foreground-muted">Small</span>
				<Progress value={50} size="sm" />
			</div>
			<div>
				<span className="mb-2 block text-sm text-foreground-muted">Medium</span>
				<Progress value={65} size="md" />
			</div>
			<div>
				<span className="mb-2 block text-sm text-foreground-muted">Large</span>
