...
export const VariantsDemo: React.FC = () => {
  return (
    <div className="my-6 space-y-4 w-64">
      <Progress value={60} variant="default" showLabel aria-label="Default progress" />
      <Progress value={75} variant="success" showLabel aria-label="Success progress" />
      <Progress value={45} variant="warning" showLabel aria-label="Warning progress" />
      <Progress value={30} variant="destructive" showLabel aria-label="Error progress" />
    </div>
  );
};
...
export const AnimatedDemo: React.FC = () => {
  ...
  return (
    <div className="my-6 space-y-4 w-64">
      <Progress value={progress} variant="success" showLabel aria-label="Animated progress" />
    </div>
  );
};
...
export const CustomMaxDemo: React.FC = () => {
  return (
    <div className="my-6 space-y-4 w-64">
      ...
      <Progress value={250} max={500} variant="warning" showLabel aria-label="Large max value" />
    </div>
  );
};
    ...
    <div className="my-6 space-y-4 w-64">
      <div className="border border-nocta-300 dark:border-nocta-700 rounded-lg p-4">
        ...
        <button
          ...
          className="mt-3 px-3 py-1.5 text-sm bg-linear-to-b from-nocta-900 to-nocta-700 dark:from-white dark:to-nocta-300 text-white dark:text-nocta-900 rounded-md hover:bg-nocta-900 dark:hover:bg-nocta-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
