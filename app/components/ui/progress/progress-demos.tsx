    ...
    <div className="my-6 space-y-4 w-64">
      <div className="border border-neutral-300 dark:border-neutral-700 rounded-lg p-4">
        ...
        <button
          ...
          className="mt-3 px-3 py-1.5 text-sm bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 rounded-md hover:bg-neutral-800 dark:hover:bg-neutral-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
