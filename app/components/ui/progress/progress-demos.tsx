...
export const SizesDemo: React.FC = () => {
  return (
    <div className="my-6 w-64 space-y-4">
      <div>
        <span className="text-foreground-muted mb-2 block text-sm">Small</span>
        <Progress value={50} size="sm" />
      </div>
      <div>
        <span className="text-foreground-muted mb-2 block text-sm">Medium</span>
        <Progress value={65} size="md" />
      </div>
      <div>
        <span className="text-foreground-muted mb-2 block text-sm">Large</span>
