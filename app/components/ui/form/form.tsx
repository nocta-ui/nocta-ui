...
export const FormLabel: React.FC<FormLabelProps> = ({
	...
	return (
		<AriakitFormLabel
			name={name}
			className={cn(
				'block text-sm leading-none font-medium text-foreground-muted peer-disabled:cursor-not-allowed peer-disabled:opacity-70',
				className,
			)}
			{...props}
		>
...
export const FormDescription: React.FC<FormDescriptionProps> = ({
	...
	return (
		<AriakitFormDescription
			name={name}
			className={cn(
				'text-sm leading-relaxed text-foreground-subtle',
				className,
			)}
			{...props}
		>
