...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Textarea with Helper Text"
    <Textarea 
      label="Description" 
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Textarea Resize Options"
    <Textarea 
      label="No Resize"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Textarea Row Configuration"
    <Textarea 
      label="2 Rows"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Disabled Textarea State"
    <Textarea 
