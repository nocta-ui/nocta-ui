...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Custom Styling"
      <Badge
        className="bg-linear-to-r dark:from-purple-500 dark:to-pink-500 from-purple-500 to-pink-500 text-white dark:text-white">
          Gradient
      </Badge>
      <Badge 
        variant="secondary" 
        className="bg-blue-500 dark:bg-blue-500/50 text-white dark:text-white shadow-lg">
          Custom Color
      </Badge>
      <Badge
