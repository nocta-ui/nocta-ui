...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-6 not-prose">
  <div className="space-y-2">
    <div className="h-12 bg-neutral-50 dark:bg-neutral-950 rounded-lg border"></div>
  ...
  <div className="space-y-2">
    <div className="h-12 bg-neutral-700 dark:bg-neutral-300 rounded-lg"></div>
    <div className="text-xs font-mono">neutral-700</div>
  </div>
  <div className="space-y-2">
    <div className="h-12 bg-neutral-900 dark:bg-neutral-100 rounded-lg"></div>
