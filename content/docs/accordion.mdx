...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Multiple Open Accordion"
    import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@/components/ui/accordion';
    ...
    export function SizeAccordionDemo() {
      return (
        <div className="w-full max-w-2xl mx-auto space-y-8">
          <div>
            <h3 className="text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-2">Small</h3>
            <Accordion size="sm">
          ...
          <div>
            <h3 className="text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-2">Medium (Default)</h3>
            <Accordion size="md">
          ...
          <div>
            <h3 className="text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-2">Large</h3>
            <Accordion size="lg">
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Controlled Accordion"
