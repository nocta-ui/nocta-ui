    ...
    export function SizeAccordionDemo() {
      return (
        <div className="w-full max-w-2xl mx-auto space-y-8">
          <div>
            <h3 className="text-sm font-medium text-foreground-muted mb-2">Small</h3>
            <Accordion size="sm">
          ...
          <div>
            <h3 className="text-sm font-medium text-foreground-muted mb-2">Medium (Default)</h3>
            <Accordion size="md">
          ...
          <div>
            <h3 className="text-sm font-medium text-foreground-muted mb-2">Large</h3>
            <Accordion size="lg">
        ...
        <div className="w-full max-w-md mx-auto space-y-4">
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 bg-blue-500 text-primary-foreground rounded text-sm"
            >
              Open First
            </button>
            <button
              onClick={() => setOpenItems(['controlled-2'])}
              className="px-3 py-1 bg-green-500 text-primary-foreground rounded text-sm"
            >
              Open Second
            </button>
            <button
              onClick={() => setOpenItems([])}
              className="px-3 py-1 bg-red-500 text-primary-foreground rounded text-sm"
            >
              Close All
            </button>
          </div>
