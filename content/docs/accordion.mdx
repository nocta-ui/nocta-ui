    ...
    export function SizeAccordionDemo() {
      return (
        <div className="w-full max-w-2xl mx-auto space-y-8">
          <div>
            <h3 className="text-sm font-medium text-primary-muted mb-2">Small</h3>
            <Accordion size="sm">
          ...
          <div>
            <h3 className="text-sm font-medium text-primary-muted mb-2">Medium (Default)</h3>
            <Accordion size="md">
          ...
          <div>
            <h3 className="text-sm font-medium text-primary-muted mb-2">Large</h3>
            <Accordion size="lg">
