...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Custom Maximum Value"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Progress Without Label"
    <Progress value={40} />
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="File Upload Progress"
...
```tsx title="Accessibility Example"
<Progress 
  value={50} 
