...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Tooltip Positioning"
    <Tooltip>
      <TooltipTrigger asChild>
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Tooltip Alignment"
    <Tooltip>
      <TooltipTrigger asChild>
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Rich Tooltip Content"
    <Tooltip>
      <TooltipTrigger asChild>
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Tooltip Without Arrow"
    <Tooltip>
      <TooltipTrigger asChild>
...
```tsx lineNumbers title="Controlled Tooltip"
