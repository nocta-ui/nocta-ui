...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Tooltip with Text Trigger"
    <span>
      This text has a 
      <Tooltip>
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Rich Tooltip Content"
    <Tooltip>
      <TooltipTrigger asChild>
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Tooltip Delay Duration"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Tooltip Without Arrow"
    <Tooltip>
      <TooltipTrigger asChild>
