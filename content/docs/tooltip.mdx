...
<TypeTable
  type={{
    ...
    gutter: {
      description: 'Override the spacing from the trigger (falls back to tooltip context)',
      type: 'number',
      default: '0',
    },
    children: {
...
TooltipContent accepts any valid `div` HTML attributes in addition to the props above.
