---
title: Table
description: A powerful, highly customizable table component with pagination and advanced rendering features
---
        ...
        render: (value, record) => (
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-foreground-subtle truncate">{record.email}</div>
            </div>
          </div>
        )
      },
