...
```tsx title="Custom Dialog Styling"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Dialog Without Close Button"
    <Dialog>
      <DialogTrigger asChild>
