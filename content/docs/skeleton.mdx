...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Pulse Animation"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Card Skeleton"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Article Skeleton"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ```tsx lineNumbers title="Table Skeleton"
...
```tsx lineNumbers title="Loading States"
...
```tsx lineNumbers title="Conditional Rendering"
return (
  <div className="space-y-4">
    {posts.length > 0 ? (
...
```tsx
<Skeleton 
  className="rounded-xl border border-nocta-200" 
  width="300px" 
  height="200px" 
/>
```
