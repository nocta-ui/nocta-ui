...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Custom Range & Formatting"
    // Temperature slider
    <Slider 
      min={16}
      max={30}
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Vertical Orientation"
    <Slider 
