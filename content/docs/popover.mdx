...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Rich Popover Content"
    <Popover>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-neutral-300 dark:border-neutral-700 rounded-md"
              required
            />
          </div>
          ...
          <div className="flex gap-2 pt-2">
            <button type="submit" className="flex-1 px-3 py-2 text-sm bg-neutral-900 text-white rounded-md">
              Create
            </button>
...
```tsx title="Event Handling Example"
<Popover>
...
```tsx title="Conditional Rendering Example"
