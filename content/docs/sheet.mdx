        ...
        <div className="px-6 py-4 flex-1">
          <nav className="space-y-2">
            {menuItems.map((item, index) => (
                <button
                 key={index}
                 className="w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium text-left text-nocta-700 dark:text-nocta-300 hover:bg-nocta-100 dark:hover:bg-nocta-900 transition-colors duration-200"
               >
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" lineNumbers title="Code">
    ...
    <Sheet>
      ...
      <SheetContent 
        showClose={false} 
        className="bg-gradient-to-b from-nocta-50 to-white dark:from-nocta-950 dark:to-nocta-900"
      >
