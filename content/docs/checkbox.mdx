...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Disabled Checkbox State"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Checkbox Form Example"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Custom Checkbox Styling"
...
<DocsTabs defaultValue="preview">
  ...
  <DocsTab value="code" title="Code">
    ```tsx title="Checkbox with Labels"
