...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `children` | `React.ReactNode` | — | Sub trigger and content |
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `children` | `React.ReactNode` | — | Trigger content (shows arrow automatically) |
| `disabled` | `boolean` | `false` | Disable the sub trigger |
| `inset` | `boolean` | `false` | Add left padding for alignment |
| `className` | `string` | — | Additional CSS classes |
...
All components also accept their respective HTML element props. 