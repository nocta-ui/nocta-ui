...
const menubarVariants = cva(
	'relative inline-flex items-center rounded-md border border-border bg-card p-1 shadow-sm card-highlight',
	{
		variants: {
			size: {
				md: '',
...
const menubarContentVariants = cva(
	'z-50 min-w-[12rem] origin-top rounded-md border border-border bg-popover shadow-md card-highlight -translate-y-2 scale-95 opacity-0 transition-[translate,opacity,scale] duration-300 ease-smooth data-enter:translate-y-0 data-enter:scale-100 data-enter:opacity-100 data-leave:-translate-y-2 data-leave:scale-95 data-leave:opacity-0',
	{
		variants: {
			size: {
				md: 'p-1',
...
const menubarSubContentVariants = cva(
	'z-50 min-w-[10rem] origin-top-left rounded-md border border-border bg-popover shadow-md card-highlight -translate-y-2 scale-95 opacity-0 transition-[translate,opacity,scale] duration-300 ease-smooth data-enter:translate-y-0 data-enter:scale-100 data-enter:opacity-100 data-leave:-translate-y-2 data-leave:scale-95 data-leave:opacity-0',
	{
		variants: {
			size: {
				md: 'p-1',
