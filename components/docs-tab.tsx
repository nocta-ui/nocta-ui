	...
	return (
		<TabsTrigger
			...
			className={cn(
				...
				'bg-transparent border border-transparent !text-foreground/70 hover:!text-foreground data-[active-item]:!bg-card-muted dark:data-[active-item]:!bg-card-muted/30 data-[active-item]:!text-foreground data-[active-item]:!shadow-none data-[active-item]:border',
			)}
		>
			{icon && (
				<span
