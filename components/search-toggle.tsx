...
export function LargeSearchToggle({
	...
	return (
		<button
			...
			{...props}
			className={cn(
				'inline-flex items-center gap-2 rounded-md border bg-card p-1.5 ps-2 text-sm text-fd-muted-foreground transition-colors duration-200 ease-in-out hover:bg-card-muted hover:text-fd-accent-foreground/70',
