...
const optionVariants = cva(
	'inline-flex items-center gap-2 rounded-lg p-2 text-sm text-foreground-muted hover:bg-background-muted hover:text-foreground [&_svg]:size-4',
);
	...
	return (
		<Popover>
			...
			<PopoverContent
				portal
				fixed
				className="flex flex-col overflow-auto bg-background !p-1"
			>
				{items.map((item) => (
					<a
						key={item.href}
