...
function TOCItem({
	...
	return (
		<Primitive.TOCItem
			...
			className="relative prose py-1.5 text-sm [overflow-wrap:anywhere] text-foreground-muted/75 transition-colors first:pt-0 last:pb-0 hover:text-foreground-muted data-[active=true]:text-foreground"
		>
			{offset !== upperOffset ? (
				<svg
