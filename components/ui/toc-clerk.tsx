...
function TOCItem({
	...
	return (
		<Primitive.TOCItem
			...
			className="relative prose py-1.5 text-sm wrap-anywhere font-medium text-foreground/70 transition-all first:pt-0 last:pb-0 hover:text-foreground data-[active=true]:text-foreground"
		>
			{offset !== upperOffset ? (
				<svg
