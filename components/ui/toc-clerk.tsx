...
function TOCItem({
	...
	return (
		<Primitive.TOCItem
			...
			className="relative prose py-1.5 text-sm wrap-anywhere text-foreground/70 transition-all first:pt-0 last:pb-0 hover:text-foreground/70 data-[active=true]:text-foreground"
		>
			{offset !== upperOffset ? (
				<svg
