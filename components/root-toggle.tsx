		...
		<Popover open={open} onOpenChange={setOpen}>
			{item && (
				<PopoverTrigger
					{...props}
					className={cn(
						'flex items-center gap-2 rounded-lg border bg-foreground/50 p-2 text-start text-foreground-subtle transition-colors hover:bg-background-muted data-[state=open]:bg-background-muted data-[state=open]:text-foreground-subtle',
						props.className,
					)}
				>
					{item}
