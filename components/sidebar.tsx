...
const itemVariants = cva(
	'cursor-pointer relative flex flex-row items-center gap-2 rounded-md p-1.5 mb-1 ps-(--sidebar-item-offset) text-start font-medium [overflow-wrap:anywhere] text-foreground/70 [&_svg]:size-4 [&_svg]:shrink-0 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none focus-visible:ring-offset-ring-offset/50 focus-visible:ring-ring/50',
	{
		variants: {
			active: {
...
export function SidebarSeparator(props: ComponentProps<'p'>) {
	return (
		<p
			{...props}
			className={cn(
				'mb-1.5 inline-flex items-center gap-2 px-2 ps-(--sidebar-item-offset) font-medium text-xs! tracking-widest text-foreground/45 uppercase empty:mb-0 [&_svg]:size-4 [&_svg]:shrink-0',
				props.className,
			)}
		>
			{props.children}
