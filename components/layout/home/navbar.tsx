...
const navItemVariants = cva(
	'inline-flex items-center gap-1 p-2 text-foreground/70 transition-all duration-100 ease-basic hover:text-foreground data-[active=true]:text-foreground [&_svg]:size-4',
);
	...
	return (
		<NavigationMenuLink asChild>
			<Link
				{...props}
				className={cn(
					'flex flex-col gap-2 rounded-lg border bg-card-muted p-3 transition-all duration-100 hover:bg-foreground/75 hover:text-foreground',
					props.className,
				)}
			>
				{props.children}
