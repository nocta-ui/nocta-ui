...
const navItemVariants = cva(
	'inline-flex items-center gap-1 p-2 text-foreground/70 transition-colors duration-300 ease-out hover:text-foreground data-[active=true]:text-foreground [&_svg]:size-4',
);
