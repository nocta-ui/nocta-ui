...
const navItemVariants = cva(
  'inline-flex items-center gap-1 p-2 text-foreground-muted/75 transition-colors hover:text-foreground duration-300 ease-in-out data-[active=true]:text-foreground [&_svg]:size-4'
)
  ...
  return (
    <NavigationMenuLink asChild>
      <Link
        {...props}
        className={cn(
          'bg-background-muted hover:bg-foreground/80 hover:text-foreground flex flex-col gap-2 rounded-lg border p-3 transition-colors',
          props.className
        )}
      >
        {props.children}
