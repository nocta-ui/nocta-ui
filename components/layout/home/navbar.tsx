...
const navItemVariants = cva(
	'inline-flex items-center gap-1 p-2 text-foreground/70 transition-colors duration-300 ease-in-out hover:text-foreground data-[active=true]:text-foreground [&_svg]:size-4',
);
	...
	return (
		<NavigationMenu value={value} onValueChange={setValue} asChild>
			<header
				...
				{...props}
				className={cn(
					'fixed top-(--fd-banner-height) right-(--removed-body-scroll-bar-size,0) left-0 z-40 border-b border-dashed backdrop-blur-lg transition-colors *:mx-auto *:max-w-fd-container',
