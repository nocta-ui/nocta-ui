...
const navItemVariants = cva(
	'inline-flex items-center gap-1 p-2 text-foreground-muted/75 transition-colors duration-300 ease-in-out hover:text-foreground data-[active=true]:text-foreground [&_svg]:size-4',
);
