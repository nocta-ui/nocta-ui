...
function CopyButton({ className, onCopy, ...props }: CopyButtonProps) {
	...
	return (
		<button
			type="button"
			className={cn(
				'inline-flex items-center justify-center text-foreground/70 rounded-md p-2 text-sm font-medium transition-all duration-150 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
				'hover:bg-card-muted hover:text-foreground transition-all duration-150 ease-basic',
