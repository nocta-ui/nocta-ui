...
<TypeTable
  type={{
    ...
    portal: {
      description: 'Render the popover content inside a portal',
      type: 'boolean',
      default: 'true',
    },
    fixed: {
      description: 'Use CSS `position: fixed` for the floating panel',
      type: 'boolean',
      default: 'false',
    },
    gutter: {
      description: 'Distance between the trigger and this popover content',
      type: 'number',
      default: '0',
    },
    showArrow: {
