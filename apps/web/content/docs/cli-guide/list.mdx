...
description: Explore Nocta UI components available in the registry.
---
...
- Override the registry location with `--registry-url` or the `NOCTA_REGISTRY_URL` environment variable.
