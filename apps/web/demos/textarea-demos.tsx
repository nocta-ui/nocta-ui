...
import { Textarea } from '@nocta/registry/ui/textarea';
...
export const TextareaVariantsDemo: React.FC = () => {
	return (
...
export const TextareaSizesDemo: React.FC = () => {
	return (
		<div className="my-6 w-96 space-y-4">
			<Textarea
...
export const TextareaDisabledStateDemo: React.FC = () => {
	return (
		<div className="my-6 w-96 space-y-4">
			<Textarea
...
export const TextareaReadOnlyStateDemo: React.FC = () => {
	return (
		<div className="my-6 w-96">
			<Textarea
