...
import { Separator } from '@nocta/registry/ui/separator';

export const BasicSeparatorDemo: React.FC = () => {
	return (
		<div className="relative my-6 space-y-4 rounded-lg border border-border bg-card p-4 shadow-md card-highlight">
			<div>
...
export const VerticalSeparatorDemo: React.FC = () => {
	return (
		<div className="relative my-6 flex items-center gap-4 rounded-lg border border-border bg-card p-2 text-sm shadow-md card-highlight text-foreground font-medium">
			<span>Overview</span>
...
export const VariantsSeparatorDemo: React.FC = () => {
	return (
		<div className="relative my-6 space-y-4 rounded-lg border border-border bg-card shadow-md card-highlight p-4">
