...
import {
	...
	CardHeader,
	CardTitle,
} from '@nocta/registry/ui/card';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@nocta/registry/ui/tabs';
...
export const TabsVariantsDemo: React.FC = () => {
	return (
...
export const TabsSizesDemo: React.FC = () => {
	return (
